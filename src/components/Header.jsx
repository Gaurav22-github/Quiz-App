...
const Header = () => {
  ...
  return (
    <div className="w-full shadow-lg sticky top-0 z-10 bg-gradient-to-r from-red-400 to-orange-400 py-5 px-8 flex justify-between items-center text-white">
      ...
      {/* Mobile Navigation */}
      <ul
        className={`w-full gap-6 font-bold text-[18px] h-screen bg-gradient-to-r from-blue-100 to-green-100 text-white sm:hidden absolute top-[76px] transition-all duration-300 ease-linear ${
